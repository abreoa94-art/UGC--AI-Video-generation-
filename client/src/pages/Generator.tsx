...
const Generator = () => {
  ...
  const handleGenerate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if(!user) return toast('Please sign in to generate images', {icon: '🔒'});
    if(!productImage || !modelImage || !name ||!productName || !aspectRatio) return toast.error('Please fill in all required fields and upload images');
