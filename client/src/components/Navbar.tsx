            ...
            <div className='max-w-6xl mx-auto flex items-center justify-between bg-black/50 backdrop-blur-md border border-white/4 rounded-2xl p-3'>
                        ...
                        <div className='flex gap-2 items-center'>
                            ...
                            <UserButton >
                                <UserButton.MenuItems>
                                    ...
                                    <UserButton.Action label='MyGenerations ' labelIcon={<FolderEditIcon size={14} />} onClick={()=> navigate('/my-generations')} />
                ...
                {user ? (
                    <div className='flex md:hidden gap-2 items-center'>
                        <GhostButton onClick={()=> navigate('/plans')} className='border-none text-gray-300 text-xs py-1.5' >
                            Credits: {credits}
                        </GhostButton>
                        <UserButton >
                            <UserButton.MenuItems>
